...
- [ ] 7.2 Produce the designs in Claude Design and pick a mode-selector layout; validate against the base design system
- [ ] 7.3 Integrate the handoff: map markup to Next components + tokens/styles
