...
| [0012](./0012-auth-session-mechanics.md) | Mecánicas de auth y sesión: email único + membresía cerrada, recordado por refresh token, PIN solo al cambiar lector (refina ADR-0011) | Accepted *(PIN/switch superseded by ADR-0013)* |
| [0013](./0013-reader-attribution-no-switch.md) | Sin cambio de lector — atribución por picker, PIN dormido (supersede en parte a ADR-0012) | Accepted |
